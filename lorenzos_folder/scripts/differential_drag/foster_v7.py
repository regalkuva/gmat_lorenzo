...
rel_tol = 1e-6
time_step = 864<<u.s
pred_days =  (assignment-delta_nu)/0.667
...
tra_orb_pred_high = trailing_orbit.propagate(pred_days<<u.day, method=CowellPropagator(rtol=rel_tol, f=perturbations_coesa_J2_high))       
...
tra_orb_pred_low = trailing_orbit.propagate(pred_days<<u.day, method=CowellPropagator(rtol=rel_tol, f=perturbations_coesa_J2_low))
...
if (t_wait) > (60*60*24*50):
    print((t_wait)/(60*60*24))
    attempts = 2
    t_prop = (t_wait-(60*60*24*50))<<u.s
    num_prop = int(t_prop.value / time_step.value)
    tofs_prop = TimeDelta(np.linspace(0, t_prop, num=num_prop))

    reference_ephem = reference_orbit.to_ephem(EpochsArray(start_date_prop + tofs_prop, method=CowellPropagator(rtol=rel_tol, f=perturbations_coesa_J2_high)))
    trailing_ephem = trailing_orbit.to_ephem(EpochsArray(start_date_prop + tofs_prop, method=CowellPropagator(rtol=rel_tol, f=perturbations_coesa_J2_high)))
    ...
    pred_days = ((assignment - argl_difference(reference_orbit.argp.value, reference_orbit.nu.value, trailing_orbit.argp.value, trailing_orbit.nu.value))%360)/0.667
...
reference_ephem = reference_orbit.to_ephem(EpochsArray(start_date_prop + tofs_wait, method=CowellPropagator(rtol=rel_tol, f=perturbations_coesa_J2_low)))
trailing_ephem = trailing_orbit.to_ephem(EpochsArray(start_date_prop + tofs_wait, method=CowellPropagator(rtol=rel_tol, f=perturbations_coesa_J2_low)))
...
reference_ephem = reference_orbit.to_ephem(EpochsArray(reference_ephem.epochs[-1] + tofs_hd, method=CowellPropagator(rtol=rel_tol, f=perturbations_coesa_J2_low)))
trailing_ephem = trailing_orbit.to_ephem(EpochsArray(trailing_ephem.epochs[-1] + tofs_hd, method=CowellPropagator(rtol=rel_tol, f=perturbations_coesa_J2_high)))
...
reference_ephem = reference_orbit.to_ephem(EpochsArray(reference_ephem.epochs[-1] + tofs_prop, method=CowellPropagator(rtol=rel_tol, f=perturbations_coesa_J2_low)))
trailing_ephem = trailing_orbit.to_ephem(EpochsArray(trailing_ephem.epochs[-1] + tofs_prop, method=CowellPropagator(rtol=rel_tol, f=perturbations_coesa_J2_low)))
