## ORBIT PROPAGATOR WITH J2 + ATMOSPHERIC DRAG + 3rd BODY (SUN)
...
from poliastro.constants import rotational_period_sun
...
def j2_coesa_sun(t0, state, k, J2, R, C_D, A_over_m, k_third, r_third):
