### ORBIT PROPAGATOR - J2 + ATMOSPHERIC DRAG + 3rd BODY (Sun) PERTUBATIONS
...
from poliastro.constants import rho0_earth, H0_earth, rotational_period_sun
...
print('\n--- TWO-BODY PROPAGATOR - J2, ATMOSPHERIC DRAG and THIRD BODY (Sun) PERTUBATIONS ---\n')
...
body_r = build_ephem_interpolant(Sun, rotational_period_sun, (start_date, start_date + time_frame), rtol=1e-5)
...
#@jit
def a_d(t0, state, k, J2, R, C_D, A_over_m, H0, rho0, k_third, pert_body):
