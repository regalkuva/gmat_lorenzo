...
In order to provide a better understanding of the problem, figure \ref{sso_curtis} shows an example of an SSO with an LTAN of 15:00.
\begin{figure} 
    \begin{center} 
...
\subsection{Repeat-Groundtrack Orbit}
The peculiarity of a \textit{repeat-groundtrak orbit} is the repetitive transit of the satelite to the same location relative to the surface of the Earth after a certain time interval \cite{wertz2009orbit}.
